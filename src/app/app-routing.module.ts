...
import { authGuard, authGuardLoggedIn } from './shared/services/auth.guard';
...
const routes: Routes = [
  ...
  { path: 'add-routine', loadChildren: () => import('./pages/add-routine/add-routine.module').then(m => m.AddRoutineModule) },
